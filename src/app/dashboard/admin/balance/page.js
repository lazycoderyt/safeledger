...
/**
 * app/dashboard/admin/balance/page.js
 * Fund Account — searchable list of every real user (profiles joined
 * with their live account balance). Tapping a row navigates to
 * /dashboard/admin/balance/[id] to adjust that user's balance.
 */
...
function UserRow({ user }) {
  return (
    <Link
      href={`/dashboard/admin/balance/${user.id}`}
    ...
    <div className="mx-auto max-w-3xl space-y-6 bg-white p-4 sm:p-6 lg:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Select a user to view and adjust their ledger balance.
        </p>
      </div>
